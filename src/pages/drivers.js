...
function showDriverModal(editId) {
  ...
  <form id="df"><div class="modal-body">
    <div class="form-row-2"><div class="form-group"><label class="form-label">Full Name</label><input class="form-input" name="name" required minlength="2" maxlength="80" placeholder="e.g. Raju Patel" value="${d?.name || ''}"/></div><div class="form-group"><label class="form-label">Phone</label><input class="form-input" name="phone" required type="tel" pattern="[0-9+\-\s]{7,15}" maxlength="15" title="Valid phone number (7-15 digits)" placeholder="e.g. +91 98765 43210" value="${d?.phone || ''}"/></div></div>
    <div class="form-row-2"><div class="form-group"><label class="form-label">License Number</label><input class="form-input" name="licenseNumber" required maxlength="20" pattern="[A-Za-z0-9\-/]+" title="Alphanumeric, hyphens and slashes only" placeholder="e.g. GJ-01-20240001234" value="${d?.licenseNumber || ''}"/></div><div class="form-group"><label class="form-label">License Expiry</label><input class="form-input" name="licenseExpiry" type="date" required min="2000-01-01" value="${d?.licenseExpiry || ''}"/></div></div>
    <div class="form-group"><label class="form-label">License Categories (comma-separated: Truck,Van,Bike)</label><input class="form-input" name="licenseCategory" required maxlength="50" placeholder="Truck, Van, Bike" value="${d?.licenseCategory || ''}"/></div>
